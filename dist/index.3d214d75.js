...
var _navButtonJs = require("./components/nav-button/nav-button.js");
var _navPaginationJs = require("./components/nav-pagination/nav-pagination.js");
...
// Create Elements
const prevButton = (0, _navButtonJs.createButton)({
    text: "previous",
    classes: [
        "button--prev",
        "button--disabled"
    ...
    onClick: ()=>{
        ...
        if (page <= 1) prevButton.classList.add("button--disabled");
        if (page < maxPage) nextButton.classList.remove("button--disabled");
    }
});
const nextButton = (0, _navButtonJs.createButton)({
    text: "next",
    classes: [
        "button--next"
    ],
    onClick: ()=>{
        ...
        if (page > 1) prevButton.classList.remove("button--disabled");
        if (page >= maxPage) nextButton.classList.add("button--disabled");
    }
});
const pagination = (0, _navPaginationJs.createPagination)({
    text: "0 / 0"
});
const searchBar = (0, _searchBarJs.createSearchBar)({
    ...
    try {
        ...
        if (response.ok) {
            ...
            data.results.forEach((character)=>{
                const newCard = (0, _cardJs.createCharacterCard)(character);
...
},{"./components/card/card.js":"7G9CQ","./components/nav-button/nav-button.js":"74A3e","./components/nav-pagination/nav-pagination.js":"l3MDG","./components/search-bar/search-bar.js":"6ujMb"}],"7G9CQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createCharacterCard", ()=>createCharacterCard);
function createCharacterCard(props) {
    ...
    if (!props.gender) console.log("No gender available");
    else if (props.gender === "Male") genderIcon = `
      <span class="card__gender-icon">
        <i class="fa-solid fa-mars" style="color: #0056eb;"></i>
      </span>`;
    else if (props.gender === "Female") genderIcon = `
      <span class="card__gender-icon">
      <i class="fa-solid fa-venus" style="color: #eb0089;"></i>
      </span>`;
    else if (props.gender === "Genderless") genderIcon = `
      <span class="card__gender-icon">
...
},{}],"74A3e":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l3MDG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createPagination", ()=>createPagination);
function createPagination({ text  }) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6ujMb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createSearchBar", ()=>createSearchBar);
function createSearchBar({ placeholder , ariaLabel , onSubmit  }) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2UeK4","bB7Pu"], "bB7Pu", "parcelRequire12ae")
